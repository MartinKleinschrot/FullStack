...
describe('favoriteBlog', () => {
  ...
  test('of list with many entries is blog with most likes', () => {
    ...
    expect(result).toEqual({ _id: '5a422aa71b54a676234d17f8', title: 'Blog 2', author: 'Edsger W. Dijkstra', url: 'http://www.u.arizona.edu/~rubinson/copyright_violations/Go_To_Considered_Harmful.html', likes: 25, __v: 0 })
  })
})
